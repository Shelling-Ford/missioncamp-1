...
# 참가구분
persontypes = [u'청년', u'스탭']  # 상반기 선캠
# persontypes = [u'청년', u'대학생', u'스탭']  # 하반기 선캠

# 인터콥 훈련여부
trainings = [
    ('training1', u'비전스쿨'), ('training2', u'BTJ스쿨'), ('training3', u'월드미션'), ('training4', u'선교캠프'), ('training5', u'MIT'),
    ('training6', u'FO'), ('training7', u'C-BTJ'), ('training8', u'Y-Tentmaker'), ('training9', u'SM'), ('training10', u'기타'), ('none', u'없음')
]
...
class RegistrationForm(Form, MemberCommon):
    ...
    area_idx = SelectField(u'지부', choices=Area.get_list('cbtj'))
