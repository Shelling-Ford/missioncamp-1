...
class RegistrationForm(Form):
    ...
    training = MultiCheckboxField(u'인터콥 훈련여부', choices=[('training1', u'비전스쿨'), ('training2', u'BTJ스쿨'), ('training3', u'월드미션'), ('training4', u'선교캠프'), ('training5', u'MIT'), ('training6', u'FO'), ('training7', u'SM'), ('training8', u'인터콥캠퍼스'), ('none', u'없음')])
